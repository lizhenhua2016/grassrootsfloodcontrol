...
{
    [Route("/ZZTXExcel/downLoadExcelModel", "Get", Summary = "获取责任人下载模板")]
    [Api("责任人下载导入相关接口")]
    public class downLoadExcelModel : IReturn<UploadFileViewModel>
    {
    ...
    [Route("/ZZTXExcel/ImportExcel", "Post", Summary = "导入责任人")]
    [Api("责任人下载导入相关接口")]
    public class ImportExcel: IReturn<ExcelViewModel>
    {
    ...
    [Route("/ZZTXExcel/exportExcel", "Get", Summary = "导出责任人")]
    [Api("责任人下载导入相关接口")]
    public class exportExcel : IReturn<UploadFileViewModel>
    {
        [ApiMember(IsRequired = true, DataType = "sting", Description = "文件名称")]
        public string fileName { get; set; }
