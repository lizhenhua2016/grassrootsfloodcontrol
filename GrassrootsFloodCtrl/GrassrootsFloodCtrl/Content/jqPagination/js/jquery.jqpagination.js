...
(function ($) {
	...
	$.jqPagination = function (el, options) {
	    ...
	    base.$totalStr = base.$el.find('div');
		...
		base.setInputValue = function (page) {
		    ...
		    var page_string = base.options.page_string,
		        total_string= base.options.total_string,
				max_page	= base.options.max_page,
			    page_size   = base.options.page_size,
				total       = base.options.total;
			
			if (total && page_size) {
			    max_page = (total % page_size == 0 ? total / page_size : (parseInt(total / page_size) + 1));
			    total_string = total_string.replace("{total}", total);
			    base.$totalStr.html(total_string);
			}
			// this looks horrible :-(
