...
L.TileLayer = L.Class.extend({
	...
	getTileUrl: function (tilePoint) {
	    ...
	    //alert(this.options.multi.length);
	    ...
	    return L.Util.template(lUrl, L.extend({
...
/*
* L.TileLayer.CustomArcGISServerLayer is used for putting WMS tile layers on the map.
*/
...
L.TileLayer.CustomArcGISServerLayer = L.TileLayer.extend({
    ...
    getTileUrl: function (tilePoint, zoom) { // (Point, Number) -> String
        ...
        lUrl += (lZoom - 1) + "/R" + rowID + "/C" + colID + ".png";
        return lUrl;
    }
});
...
L.ImageOverlay = L.Class.extend({
	...
	initialize: function (url, bounds, options) { // (String, LatLngBounds, Object)
		...
		this._maxZoom = options.maxZoom; //add by lck 20131110
		L.setOptions(this, options);
	},
...
L.Marker = L.Class.extend({
	...
	initialize: function (latlng, options) {
	    ...
	    if (options.visible != undefined) {
	        this._visible = options.visible;  //初始化为显示  LCK
	    } else {
	...
	setVisible: function (visible) {
	    ...
	    this._icon.style.display = visible;
	},
