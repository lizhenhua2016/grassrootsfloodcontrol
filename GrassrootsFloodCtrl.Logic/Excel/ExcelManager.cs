                ...
                try
                {
                    ...
                    for (var k = 0; k < dt.Rows.Count; k++)
                    {
                        ...
                        else if (request.typeId == 3)
                        {
                            ...
                            var adcdInfo = adcdList.Where(w => w.adnm == dr[0].ToString().Trim()).FirstOrDefault();
                            villageTransferPerson.adcd = adcdInfo.adcd;
                            ...
                            if (db.Insert(villageTransferPerson) == 1)
                            {
                                ...
                                //    {
                                //        adcdId = adcdInfo.Id,
                                //        phone = villageTransferPerson.PersonLiableMobile,
                                //        username = villageTransferPerson.PersonLiableName
                                //    };
                                //    _ListAdcdItems.Add(_AdcdItems);
                                //    _AdcdItems = new AdcdItems()
                                //    {
                                //        adcdId = adcdInfo.Id,
                                //        phone = villageTransferPerson.WarnPersonLiableMobile,
                                //        username = villageTransferPerson.WarnPersonLiableName
                                //    };
                                //    _ListAdcdItems.Add(_AdcdItems);
                                //    _AdcdItems = new AdcdItems()
                                //    {
                                //        adcdId = adcdInfo.Id,
                                //        phone = villageTransferPerson.DisasterPreventionManagerMobile,
                                //        username = villageTransferPerson.DisasterPreventionManager
                                //    };
                                //    _ListAdcdItems.Add(_AdcdItems);
                        ...
                        else if (request.typeId == 4)
                        {
                            ...
                            var adcdinfo = adcdList.Where(w => w.adnm == dr[0].ToString().Trim()).FirstOrDefault();
                            townPersonLiable.adcd = adcdinfo.adcd;
                            ...
                            {
                               // _IAppRegPersonUpdate.AppRegPersonSaveOne(new AppRegPersonSaveOne() { adcdid =adcdinfo.Id, username=townPersonLiable.Name, hanphone = townPersonLiable.Mobile });
                                successCount++;
                            }
                            else
                            {
