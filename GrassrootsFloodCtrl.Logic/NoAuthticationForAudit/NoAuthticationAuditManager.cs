...
{
    public class NoAuthticationAuditManager : ManagerBase, NoAuthticationIAuditManager
    {
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public BsTableDataSource<AuditViewModel> NoAuthticationGetAuditApplication(NoAuthticationGetAuditApplication request)
        {
            var _year = System.DateTime.Now.Year;
            try
            {
                using (var db = DbFactory.Open())
                {
                    ...
                    if (request.level.Value == 3)
                    {
                        ...
                        //统计
                        //待审批
                        var lable1 = NoAuthticationgetCount(1, 6, _adcd);
                        //已审未批
                        var lable2 = NoAuthticationgetCount(2, 6, _adcd);
                        //已批
                        var lable3 = NoAuthticationgetCount(3, 6, _adcd);
                        //1
                        var builder = db.From<Model.Audit.Audit>();
                    ...
                    if (request.level.Value == 2)
                    {
                        ...
                        //待审批
                        var lable1 = NoAuthticationgetCount(1, 4, _adcd);
                        //已审未批
                        var lable2 = NoAuthticationgetCount(2, 4, _adcd);
                        //已批
                        var lable3 = NoAuthticationgetCount(3, 4, _adcd);
                        //1
                        var builder = db.From<Model.Audit.Audit>();
                        builder.LeftJoin<Model.Audit.Audit, ADCDInfo>((x, y) => x.TownADCD == y.adcd);
        ...
        public BsTableDataSource<AuditCountyViewModel> NoAuthticationGetAuditApplicationCounty(NoAuthticationGetAuditApplicationCounty request)
        {
            var _year = System.DateTime.Now.Year;
            try
            {
                using (var db = DbFactory.Open())
                {
                    ...
                    //var leng = string.IsNullOrEmpty(request.adcd)
                    //待审批
                    var lable1 = NoAuthticationgetCountCounty(1, 4, _adcd);
                    //已审批
                    var lable2 = NoAuthticationgetCountCounty(3, 4, _adcd);
                    //1
        ...
        /// <returns></returns>
        public int NoAuthticationgetCount(int _status, int len, string _adcd)
        {
            using (var db = DbFactory.Open())
            {
        ...
        public int NoAuthticationgetCountCounty(int _status, int len, string _adcd)
        {
            using (var db = DbFactory.Open())
            {
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public BaseResult NoAuthticationPostAudit(NoAuthticationPostAudit request)
        {
        ...
        public List<AuditViewModel> NoAuthticationGetAuditNo(NoAuthticationGetAuditNo request)
        {
            if (null == request.id) throw new Exception("参数异常");
            var _year = System.DateTime.Now.Year;
            using (var db = DbFactory.Open())
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public List<ADCDInfo> NoAuthticationGetAreaList(NoAuthticationGetAreaList request)
        {
        ...
        public AuditOtherViewModel NoAuthticationGetAuditNumByADCD(NoAuthticationGetAuditNumByADCD request)
        {
            try
            {
                using (var db = DbFactory.Open())
